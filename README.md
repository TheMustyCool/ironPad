...
Ironpad is a local-first, file-based project management system. Built with the help of AI, it simplifies task management while keeping your data secure and accessible. The Rust backend uses Axum for efficiency, while the Vue 3 frontend offers a smooth user experience. Ironpad uses markdown files as the database, allowing for easy version control with built-in Git integration.
...
- **Local-First Design:** Your data remains on your device, ensuring privacy and quick access.
- **File-Based Database:** Uses markdown files for easy readability and portability.
- **Task Management:** Create, edit, and delete tasks effortlessly.
- **AI Assistance:** Get intelligent suggestions to enhance productivity.
- **Git Integration:** Version control for your tasks and projects.

## 💡 Tips for Using ironPad

- **Organize Your Projects:** Create separate folders for each project to keep tasks organized.
- **Use Markdown:** Learn basic markdown to utilize all features effectively.
- **Regular Updates:** Check the Releases page for updates to benefit from new features and fixes.
...
### How do I uninstall ironPad?

Simply delete the folder where you extracted ironPad, and it will be uninstalled from your device.

### Can I contribute to ironPad?

Yes! Check the Contribution Guidelines in the repository for details on how to contribute.

### Is there a mobile version available?

Currently, ironPad is only available for desktop platforms. Future versions may offer mobile compatibility.
